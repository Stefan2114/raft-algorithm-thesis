...
const (
	KV_Get_FullMethodName = "/kvraft.kv.v1.KV/Get"
	KV_Put_FullMethodName = "/kvraft.kv.v1.KV/Put"
)
...
func _KV_Get_Handler(srv any, ctx context.Context, dec func(any) error, interceptor grpc.UnaryServerInterceptor) (any, error) {
	in := new(GetRequest)
