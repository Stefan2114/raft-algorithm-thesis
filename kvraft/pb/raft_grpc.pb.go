...
const (
	Raft_RequestVote_FullMethodName     = "/kvraft.raft.v1.Raft/RequestVote"
	Raft_AppendEntries_FullMethodName   = "/kvraft.raft.v1.Raft/AppendEntries"
	Raft_InstallSnapshot_FullMethodName = "/kvraft.raft.v1.Raft/InstallSnapshot"
)
...
var Raft_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "kvraft.raft.v1.Raft",
