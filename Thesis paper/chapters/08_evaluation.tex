...
The chaos engine operates concurrently with the client.
This "stress testing" ensures that edge cases—such as a leader failing exactly at the moment of commitment—are correctly handled without data loss.
